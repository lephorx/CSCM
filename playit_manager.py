...
async def create_tunnel(tunnel_name: str, tunnel_port: int | str) -> str | None:
    ...
    try:
        ...
        # Click Next
        print("Clicking Next (tunnel name)...")
        await page.click('button[type="submit"]')
        await asyncio.sleep(1)
        ...
        # Click Next
        print("Clicking Next (tunnel type)...")
        await page.click('button[type="submit"]')
        await asyncio.sleep(1)
        ...
        """)
        await page.type('input[placeholder="NULL"]', str(tunnel_port), {"delay": 50})
        await asyncio.sleep(0.5)
        
        # Click Next (submit port)
        print("Clicking Next (port)...")
